...
import { ArrowRight, Play, TrendingUp, Award, Users, CheckCircle2 } from "lucide-react";
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="space-y-8 animate-fade-in">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 pt-4">
                                ...
                                <button className="group px-8 py-4 bg-white text-emerald-600 rounded-2xl font-semibold 
            ...
            <section className="py-24 bg-white">
                <div className="container mx-auto px-6 lg:px-24 xl:px-32">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            { icon: StrategyIcon, title: "Strategic Planning", desc: "Data-driven strategies for sustainable growth" },
                            { icon: MarketingIcon, title: "Marketing & PR", desc: "Amplify your brand presence and reach" },
                            { icon: DesignIcon, title: "Design & Production", desc: "Stunning visuals that captivate audiences" },
                            { icon: ResearchIcon, title: "Research & Training", desc: "Deep insights and skill development" },
                        ].map((item, index) => (
                            <div
                                key={index}
