...
const featuredProjects = [
  {
    ...
    category: "Events",
    image: CarnivalImg,
    metrics: { reach: "250K+", engagement: "18.5%", roi: "340%", conversions: "12,450", client: "Sally Production Ltd." },
  },
  {
    id: 2,
    ...
    category: "Corporate",
    image: CampaignImg,
    metrics: { reach: "500K+", engagement: "24.2%", roi: "420%", conversions: "28,900", client: "TechCorp Global" },
  },
  {
    id: 3,
    ...
    category: "Education",
    image: Image1,
    metrics: { reach: "320K+", engagement: "22.8%", roi: "380%", conversions: "19,200", client: "EduLearn International" },
  },
];
...
const testimonials = [
  {
    ...
    rating: 5,
    quote:
      "Working with this team has been transformative. Their strategic approach and creative solutions have exceeded our expectations and delivered measurable results for our business.",
  ...
  },
  {
    ...
    rating: 5,
    quote:
      "The data-driven approach and attention to detail resulted in a 420% ROI. Our brand awareness increased by 85% within the first quarter.",
  ...
  },
  {
    ...
    rating: 5,
    quote:
      "Outstanding results! We saw a 380% ROI and our student enrollment increased by 45% after their campaign launch.",
...
function SectionHeader({ badgeIcon: BadgeIcon, badgeText, title, desc, align = "center" }) {
  ...
  return (
    <div className={`${isCenter ? "text-center" : ""} mb-16`}>
      ...
      <h2 className="text-4xl lg:text-5xl font-bold text-slate-900 mb-4">{title}</h2>
      {desc ? <p className="text-lg text-slate-600 max-w-2xl mx-auto">{desc}</p> : null}
    </div>
  );
}
...
function IconPill({ icon: Icon, label }) {
  return (
    <div className="flex items-center gap-2">
      <Icon className="text-emerald-600 shrink-0" size={18} />
  ...
  return (
    <div className="flex items-center gap-4 p-4 bg-white/10 rounded-xl">
      <div className="w-12 h-12 rounded-xl bg-white/20 flex items-center justify-center shrink-0">
        ...
        <Icon className="text-white shrink-0" size={22} strokeWidth={2} />
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <h1 className="text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight text-white">
                Provide Solutions
                <br />
                <span className="bg-gradient-to-r from-emerald-100 to-white bg-clip-text text-transparent">With Creativity</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-2">
                <Link
                  ...
                  className="group inline-flex items-center justify-center gap-3 px-8 py-4 bg-white text-emerald-700 rounded-2xl font-semibold
                             shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-[1.02]"
                >
                  <Calendar size={20} className="shrink-0" />
                  <span className="leading-none">Request a Strategy Call</span>
                ...
                <button
                  ...
                  data-cta-location="hero-section"
                  className="group inline-flex items-center justify-center gap-3 px-8 py-4 bg-white/10 backdrop-blur-sm text-white rounded-2xl font-semibold
                             border-2 border-white/30 hover:bg-white/20 transition-all duration-300"
                >
                  <span className="w-10 h-10 rounded-full bg-white/20 flex items-center justify-center group-hover:bg-white group-hover:text-emerald-700 transition-colors shrink-0">
                    <Play size={16} className="ml-0.5 shrink-0" />
                  </span>
            ...
            <div className="relative lg:block hidden">
              <div className="relative">
                ...
                <img src={HeroImage} alt="Hero" className="relative rounded-3xl shadow-2xl w-full object-cover" />
              </div>
      ...
      <section className="py-16 bg-white border-b border-slate-200">
        <div className="container mx-auto px-6 lg:px-24 xl:px-32">
          <SectionHeader
            ...
            desc="We're proud to work with forward-thinking companies across diverse industries"
          />
            ...
            {clientLogos.map((client, index) => (
              <div
                ...
                className="group flex flex-col items-center justify-center p-6 bg-slate-50 rounded-2xl
                           hover:bg-white hover:shadow-lg transition-all duration-300 border border-slate-200 hover:border-emerald-300"
              >
                <div className="w-20 h-20 rounded-xl bg-emerald-100 flex items-center justify-center mb-3 group-hover:bg-emerald-200 transition-colors">
                  <div className="text-2xl font-bold text-emerald-700">{getInitials(client.name)}</div>
                </div>
              ...
              >
                <div
                  className="absolute inset-0 bg-gradient-to-br from-emerald-50/0 to-emerald-50/0
                             group-hover:from-emerald-50/50 group-hover:to-transparent rounded-3xl transition-all duration-500"
                />
            ...
            {[
              ...
              <div
                ...
                className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 border border-white/20
                           hover:bg-white/20 hover:scale-[1.02] transition-all duration-300 text-center group"
              >
                <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-white/20 flex items-center justify-center group-hover:bg-white/25 transition-colors">
                ...
                <div className="relative bg-white rounded-3xl p-8 border border-slate-200 hover:border-emerald-300 hover:shadow-xl transition-all duration-300 h-full">
                  <div className="flex items-start justify-between mb-6">
                    ...
                    <div className="w-12 h-12 rounded-xl bg-emerald-50 flex items-center justify-center group-hover:bg-emerald-100 transition-colors">
                      <step.icon className="text-emerald-700" size={24} />
                    </div>
                  </div>
                  <h3 className="text-xl font-bold text-slate-900 mb-3 group-hover:text-emerald-700 transition-colors">
                    {step.title}
        ...
        <div className="container mx-auto px-6 lg:px-24 xl:px-32">
          <div className="flex justify-between items-end gap-6 mb-12">
            <div>
              ...
              <h2 className="text-4xl lg:text-5xl font-bold text-slate-900">Proven Results, Real Metrics</h2>
              <p className="text-lg text-slate-600 mt-3 max-w-2xl">Data-driven success stories with measurable ROI and conversion metrics</p>
            </div>

            <Link
              to="/projects"
              className="group hidden lg:inline-flex items-center gap-2 px-6 py-3 bg-emerald-600 text-white rounded-xl font-semibold hover:bg-emerald-700 transition-all duration-300 shadow-lg hover:shadow-xl"
            >
              <span>View All</span>
            ...
            {featuredProjects.map((project) => (
              <div
                ...
                className="group relative bg-white rounded-2xl overflow-hidden border border-slate-200
                           hover:border-emerald-300 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 flex flex-col"
              >
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    <div className="bg-emerald-50 rounded-xl p-4">
                      <div className="flex items-center gap-2 mb-2">
                        <TrendingUp className="text-emerald-700 shrink-0" size={18} />
                        <span className="text-xs text-slate-600 font-medium">ROI</span>
                      </div>
                      <div className="text-2xl font-bold text-emerald-700">{project.metrics.roi}</div>
                    </div>

                    <div className="bg-slate-50 rounded-xl p-4">
                      <div className="flex items-center gap-2 mb-2">
                        <Activity className="text-slate-700 shrink-0" size={18} />
                    ...
                    <div className="bg-slate-50 rounded-xl p-4">
                      <div className="flex items-center gap-2 mb-2">
                        <Users className="text-slate-700 shrink-0" size={18} />
                    ...
                    <div className="bg-emerald-50 rounded-xl p-4">
                      <div className="flex items-center gap-2 mb-2">
                        <Target className="text-emerald-700 shrink-0" size={18} />
                        <span className="text-xs text-slate-600 font-medium">Conversions</span>
                      </div>
                      <div className="text-2xl font-bold text-emerald-700">{project.metrics.conversions}</div>
                    </div>
                  </div>

                  <Link
                    to={`/projects/${project.id}`}
                    className="inline-flex items-center justify-between mt-auto pt-4 border-t border-slate-100 group-hover:border-emerald-200 transition-colors"
                  >
                    <span className="text-sm font-semibold text-slate-700 group-hover:text-emerald-700 transition-colors">
                      View Full Case Study
                    </span>
                    <ArrowRight className="text-emerald-700 shrink-0 group-hover:translate-x-2 transition-transform" size={18} />
                  </Link>
                </div>
              </div>
            ))}
          ...
          <div className="mt-12 text-center">
            <Link
              ...
              className="inline-flex items-center gap-3 px-8 py-4 bg-emerald-600 text-white rounded-xl font-semibold
                         hover:bg-emerald-700 transition-all duration-300 shadow-lg hover:shadow-xl"
            >
              <Calendar size={20} className="shrink-0" />
              <span className="leading-none">Get Your Own Success Story</span>
        ...
        <div className="container mx-auto px-6 lg:px-24 xl:px-32">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {whyChooseUs.map((item, index) => (
              <div
                key={index}
                className="group bg-white rounded-2xl p-8 border border-slate-200 hover:border-emerald-300 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 text-center"
              >
      ...
      <section className="py-24 bg-gradient-to-br from-slate-50 to-white">
        <div className="container mx-auto px-6 lg:px-24 xl:px-32">
          <SectionHeader
            ...
            title="We Shared Value With Our Clients"
            desc="Real testimonials from clients who've achieved measurable results"
          />
                ...
                <div className="relative bg-white rounded-3xl p-8 shadow-xl border border-slate-100 hover:shadow-2xl transition-all duration-300 h-full flex flex-col">
                  <div className="flex justify-center mb-6">
                    <div className="relative">
                      ...
                      <img src={t.image} alt={t.name} className="relative w-20 h-20 rounded-full border-4 border-white shadow-lg object-cover" />
                    </div>
                  </div>
                  ...
                  <p className="text-slate-700 text-base leading-relaxed text-center mb-6 italic flex-1">"{t.quote}"</p>
                  ...
                  <div className="border-t border-slate-200 pt-6 text-center">
                    ...
                    <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-emerald-50 rounded-full">
                      <TrendingUp className="text-emerald-700 shrink-0" size={14} />
                      <span className="text-xs font-semibold text-emerald-800">{t.metrics}</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="text-center">
            <Link
              ...
              className="inline-flex items-center gap-3 px-8 py-4 bg-emerald-600 text-white rounded-xl font-semibold hover:bg-emerald-700 transition-all duration-300 shadow-lg hover:shadow-xl"
            >
              <Calendar size={20} className="shrink-0" />
              <span className="leading-none">Join Our Success Stories</span>
              <ArrowRight size={18} className="shrink-0" />
            </Link>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 lg:px-24 xl:px-32">
          <div className="flex justify-between items-end gap-6 mb-12">
            <div>
              ...
              <h2 className="text-4xl lg:text-5xl font-bold text-slate-900">News & Insights</h2>
            </div>
          ...
          <div className="space-y-6">
            {newsItems.map((item, i) => (
              <Link
                key={i}
                to="/news"
                className="group block bg-white rounded-2xl p-6 border border-slate-200 hover:border-emerald-300 hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
              >
                <div className="flex items-center gap-6">
                  ...
                  <ArrowRight
                    size={24}
                    className="text-slate-400 group-hover:text-emerald-700 group-hover:translate-x-2 transition-all flex-shrink-0 hidden lg:block"
                  />
                </div>
              </Link>
            ))}
          ...
          <div className="mt-8 lg:hidden">
            <Link
              to="/news"
              className="block w-full text-center px-6 py-3 bg-emerald-600 text-white rounded-xl font-semibold hover:bg-emerald-700 transition-all duration-300"
            >
              View All News
            </Link>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-12 border border-white/20">
              <div className="text-center mb-8">
                ...
                <p className="text-emerald-100 text-sm">Join 55+ companies already seeing measurable ROI</p>
              </div>

              {/* FIXED ICON SQUARE LOOK */}
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                <ContactTile icon={Phone} label="Phone">
                  <a href="tel:+4407772452848" className="hover:text-emerald-100 transition-colors">
                    +44 0777 245 2848
                  </a>
                </ContactTile>

                <ContactTile icon={Mail} label="Email">
                  <a href="mailto:info@marketingagency.co" className="hover:text-emerald-100 transition-colors">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  ...
                  onClick={() => trackCta({ cta_id: "final-primary", cta_variant: "strategy-call", location: "final-cta-section" })}
                  className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-white text-emerald-700 rounded-xl font-semibold
                ...
                <Link
                  ...
                  data-cta-location="final-cta-section"
                  className="px-8 py-4 bg-white/10 backdrop-blur-sm border-2 border-white text-white rounded-xl font-semibold hover:bg-white/20 transition-all duration-300 text-center"
                >
                  Start a Project
                </Link>
              </div>
