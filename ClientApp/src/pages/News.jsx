                ...
                <div className="container mx-auto px-6 lg:px-24 xl:px-32 py-6">
                    <div className="flex flex-col lg:flex-row gap-6 items-start lg:items-center justify-between">
                        ...
                        <div className="flex flex-wrap gap-3">
                            ...
                            >
                                <Filter size={16} />
                                {activeCategory === "All" ? "All Categories" : "All"}
                            </button>
                        ...
                        <div className="flex flex-wrap items-center gap-3">
                            ...
                            {trendingTags.slice(0, 3).map((tag, i) => (
                                <button
                                    key={i}
                                    ...
                                    <div className="relative h-96 lg:h-[500px] overflow-hidden">
                                        ...
                                        <div className="absolute top-6 left-6 z-20 flex gap-3">
                                            ...
                                            <span className="px-4 py-2 bg-white/90 backdrop-blur-sm text-emerald-700 rounded-full text-sm font-semibold">
                                                {filteredArticles[0].views} views
                                            </span>
                                        </div>
                                    </div>
                ...
                <div className="container mx-auto px-6 lg:px-24 xl:px-32">
                    <div className="flex items-center justify-between mb-10">
                        ...
                        <span className="text-slate-600 text-sm">
                            {filteredArticles.filter(a => !a.featured).length} articles
                        </span>
                    </div>
                ...
                <div className="container mx-auto px-6 lg:px-24 xl:px-32">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {pressReleases.map((release) => (
                            <div
                                key={release.id}
                                className="group bg-gradient-to-br from-slate-50 to-white rounded-2xl p-6 border border-slate-200 
                            ...
                            >
                                <div className="flex items-start justify-between mb-4">
                                    ...
                                    <Download className="text-slate-400 group-hover:text-emerald-600 transition-colors" size={18} />
                                </div>
