...
export default function Projects() {
  ...
  const featuredProject =
    filteredProjects.find((p) => p.featured) || filteredProjects[0] || null;

  const gridProjects = filteredProjects.filter((p) => !featuredProject || p.id !== featuredProject.id);
              ...
              <div className="relative bg-white rounded-3xl overflow-hidden shadow-2xl border border-slate-100">
                <div className="grid lg:grid-cols-2 gap-0">
                  <div className="relative h-96 lg:h-[520px] overflow-hidden">
                    ...
                    <img
                      src={featuredProject.heroImage || featuredProject.image}
                  ...
                  <div className="p-8 lg:p-12 flex flex-col justify-center bg-gradient-to-br from-white to-slate-50">
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-8 p-4 bg-slate-50 rounded-xl border border-slate-200/60">
      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-6 lg:px-24 xl:px-32">
          <div className="flex items-center justify-between mb-10">
            ...
            <span className="text-slate-600 text-sm">{gridProjects.length} projects</span>
          </div>
            ...
            {gridProjects.map((project) => (
              ...
              >
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <h3 className="text-xl font-bold text-slate-900 mb-2 line-clamp-2 group-hover:text-emerald-600 transition-colors">
                    {project.title}
                  </h3>
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {(project.tags || []).slice(0, 2).map((tag, i) => (
                      <span key={i} className="px-2 py-1 bg-emerald-50 text-emerald-700 rounded text-xs font-medium">
                        {tag}
                      </span>
                    ))}
                  </div>
                  ...
                  <div className="flex items-center justify-between mt-auto pt-4 border-t border-slate-100">
                    <span className="group inline-flex items-center gap-2 text-emerald-600 font-semibold">
                      <span>View Details</span>
                      <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
                    </span>

                    <span className="p-2 text-slate-400 group-hover:text-emerald-600 transition-colors" aria-label="View project">
                      <Eye size={16} />
                    </span>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-6 lg:px-24 xl:px-32">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Real feedback from campaigns and brand launches we delivered.
            </p>
          </div>
              ...
              .map((p) => (
                ...
                >
                  <div className="flex gap-1 mb-4">
                    {Array.from({ length: p.testimonial.rating || 5 }).map((_, j) => (
                      <Star key={j} className="text-amber-400 fill-amber-400" size={16} />
                    ))}
                  </div>
                  <p className="text-slate-700 mb-6 leading-relaxed italic">"{p.testimonial.quote}"</p>
                  <div className="border-t border-slate-100 pt-4">
                    <div className="font-semibold text-slate-900">{p.testimonial.author}</div>
      ...
      <section className="py-20 bg-gradient-to-br from-emerald-600 via-emerald-500 to-emerald-600 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-24 xl:px-32 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">Ready to Start Your Next Project?</h2>
